            ...
            <div class="card">
                ...
                <div class="card-body">
                    <form method="POST" action="{{ route('register') }}">
                        ...
                        <div class="form-group row">
                            <label for="outlet" class="col-md-4 col-form-label text-md-right">
                                {{ __('Outlet') }}
                            </label>
                            ...
                            <div class="col-md-6">
                                <!-- <input id="outlet" type="text"
                                       ...
                                       name="outlet" value="{{ old('outlet') }}" required> -->

                                       <select id="outlet" name="outlet" class="custom-select" required>
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-6">
                                       ...
                                       <select id="admin" name="admin" class="custom-select" required>
